...
def create_systemctl_service(app_info):
    ...
    app_bash_script = "{}/scripts/{}/{}.service".format(os.getcwd(), app_info["name"], app_info["name"])
...
def create_systemctl_timer(app_info):
    ...
    app_bash_script = "{}/scripts/{}/{}.timer".format(os.getcwd(), app_info["name"], app_info["name"])
